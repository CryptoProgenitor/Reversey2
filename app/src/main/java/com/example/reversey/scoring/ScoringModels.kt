...
data class ScoringParameters(
    ...
    var pitchWeight: Float = 0.6f,
    var mfccWeight: Float = 0.4f,
    ...
    var dtwNormalizationFactor: Float = 50f, // Lower is stricter for DTW

    // Detection
    var silenceThreshold: Float = 0.02f,     // RMS level below which audio is considered silent

    // Score scaling
    var minScoreThreshold: Float = 0.3f,
    var perfectScoreThreshold: Float = 0.85f,
    var scoreCurve: Float = 1.2f,
